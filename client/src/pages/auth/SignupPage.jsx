  ...
  return (
    <div className="flex min-h-screen">
      <div className="hidden w-1/2 flex-col justify-between bg-[linear-gradient(135deg,#111827_0%,#4a3412_48%,#0f172a_100%)] p-12 text-white lg:flex">
        ...
        <div>
          <h1 className="font-serif text-5xl font-bold leading-tight">Join {BRAND_NAME}.</h1>
          <p className="mt-3 text-xl text-amber-200">{BRAND_TAGLINE}</p>
          <p className="mt-6 max-w-md text-lg text-slate-200">
            Reserve tables, browse the menu, and follow every order from kitchen to bill.
          </p>
        </div>
      ...
      <div className="flex flex-1 items-center justify-center bg-slate-50 px-6 dark:bg-slate-950">
        <div className="w-full max-w-md">
          ...
          <div className="card p-8">
            <h2 className="font-serif text-3xl font-bold text-slate-900">Create account</h2>
            <p className="mt-1 text-sm text-slate-500">Sign up as a customer</p>
            ...
            <p className="mt-3 text-center text-xs text-slate-400">
              {BRAND_NAME} staff? Ask your manager for login credentials.
            </p>
          </div>
        </div>
      </div>
